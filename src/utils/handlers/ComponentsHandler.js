...
module.exports = async (client) => {
  ...
  for (const folder of componentFolders) {
    const componentFiles = readdirSync(
      `${process.cwd()}/src/components/${folder}`
    ...
    switch (folder) {
      case "buttons":
        for (const file of componentFiles) {
          ...
          if (client.config.execDev && !button.dev) {
          } else {
      ...
      case "selectMenus":
        for (const file of componentFiles) {
          ...
          if (client.config.execDev && !menu.dev) {
          } else {
      ...
      case "modals":
        for (const file of componentFiles) {
          ...
          if (client.config.execDev && !modal.dev) {
          } else {
      ...
      case "features":
        for (const file of componentFiles) {
          ...
          // console.log(feature);
          if (client.config.execDev && !feature.dev) {
          } else {
